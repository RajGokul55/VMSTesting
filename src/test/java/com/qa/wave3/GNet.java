...
public class GNet extends CommonMethods {
	...
	By lnk_BoardDirector = By.xpath("//div[@class='About']//div//a[contains(text(),'Board of Directors')]");
	By txt_BoardDirector = By.xpath("//a[contains(text(),'Board of Directors')]");
	
	By lnk_CompanyTimeline = By.xpath("//div[@class='About']//div//a[contains(text(),'Company Timeline')]");
	...
	By lnk_GileadEvents = By.xpath("//div[@class='About']//div//a[contains(text(),'Gilead Events')]");
	By txt_GileadEvents = By.xpath("//h1[contains(text(),'Gilead Events')]");
	
	By lnk_GileadOfficeDirectory = By.xpath("//div[@class='About']//div//a[contains(text(),'Gilead Office Directory')]");
	By txt_GileadOfficeDirectory = By.xpath("//strong[contains(text(),'Name and Address')]");
	
	By lnk_GileadVPDirectory = By.xpath("//div[@class='About']//div//a[contains(text(),'Gilead VP Directory')]");
	By txt_GileadVPDirectory = By.xpath("//h2[contains(text(),'Gilead VP')]");
	
	By lnk_KiteNet = By.xpath("//div[@class='About']//div//a[contains(text(),'KiteNet')]");
	...
	By lnk_Pipeline = By.xpath("//div[@class='About']//div//a[contains(text(),'Pipeline')]");
	By txt_Pipeline = By.xpath("//h1[contains(text(),'Pipeline')]");
	
	By lnk_Policies = By.xpath("//div[@class='About']//div//a[contains(text(),'Policies')]");
	By txt_Policies = By.xpath("//h1[contains(text(),'Policies Page')]");
	
	By lnk_Products = By.xpath("//div[@class='About']//div//a[contains(text(),'Products')]");
	By txt_Products = By.xpath("//span[contains(text(),'Science & Medicine')]");
	
	By lnk_SeniorLeadership = By.xpath("//div[@class='About']//div//a[contains(text(),'Senior Leadership')]");
	By txt_SeniorLeadership = By.xpath("//h1[contains(text(),'Leadership')]");
	
	By lnk_Corporatematerial = By.xpath("//div[@class='Resources']//div//a[contains(text(),'Corporate Materials')]");
	By txt_Corporatematerial = By.xpath("//*[@id='ctl00_PlaceHolderMain_Sitemappath1']/span[3]");
	
	By lnk_EmployeeResources = By.xpath("//div[@class='Resources']//div//a[contains(text(),'Employee Resources')]");
	By txt_EmployeeResources = By.xpath("//h2[contains(text(),'Employee Resources Directory')]");
	
	By lnk_EmployeeResourceGroups = By.xpath("//div[@class='Resources']//div//a[contains(text(),'Employee Resource Groups')]");
	By txt_EmployeeResourceGroups = By.xpath("//h1[contains(text(),'Employee Resource Groups')]");
	
	By lnk_GivingTogether = By.xpath("//div[@class='Resources']//div//a[contains(text(),'Giving Together')]");
	...
	By lnk_Search = By.cssSelector("#ctl00_ctl28_SmallSearchInputBox1_csr_sbox");
	...
	By txt_Ethics = By.cssSelector("body.Gilead.GNet.Publishing.ms-backgroundImage:nth-child(2) div.ms-core-overlay:nth-child(22) section.container-main:nth-child(1) section.off-canvas-wrap.docs-wrap section.inner-wrap section.content-main section.container div:nth-child(2) div:nth-child(3) div.breadcrumb:nth-child(2) span:nth-child(1) > span:nth-child(6)");
