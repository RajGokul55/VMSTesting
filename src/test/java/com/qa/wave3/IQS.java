...
public class IQS extends CommonMethods {
	...
	public void GCC_S01_Web_verifyIQSscreen() {
		TM_IQS_S01_Web_verifyIQSScreen();

	}

	@Test(priority = 0, enabled = true)
	public void GCC_S02_Web_VerifyPreviewReport() {
		TM_IQS_S02_Web_verifyPreviewReport();

	}
	
	@Test(priority = 0, enabled = true)
	public void GCC_S03_Web_VerifyQualityRecordBrowserSearch() {
		TM_IQS_S03_Web_verifyQualityRecordBrowserSearch();

	}
	
	@Test(priority = 0, enabled = false)
	public void GCC_S04_VerifyRecord_And_Attachment() {
		TM_IQS_S04_Web_verifyAttachment_Record();

	}
	
	@Test(priority = 0, enabled = true)
	public void GCC_S05_Web_VerifyIQSReportPortal() {
