...
public class ODS {
	...
	String Q_GDHODS_Account = "SELECT COUNT(*) FROM GDHODS.ACCOUNT";
	 ...
	 void TM_connectToDB_RunQuery(String Url, String User, String Pass, String Query){
		...
		// Get the contents of userinfo table from DB
			...
			while (res.next())
			{
				...
				System.out.println("No of records found : "+ res.getInt(1)+ " for Query:"+Query+ '\n' + "on this Database: " + Url + '\n');
				Reporter.log("No of records found : "+ res.getInt(1)+ " for Query:"+Query+ '\n' + "on this Database: " + Url + '\n');
