...
public class DART extends CommonMethods {

	/***************************** Test Data *******************/

	// NO NEED TO ENTER LOGIN DETAILS, BELOW USERS NEED TO LAUNCH THE URL'S, IT WILL
	// DIRECTLY OPEN THE HOME SCREEN(DART screen)


	final String Browser = "Chrome";

	// Test Environment URL
	final String Url = "http://dart.gilead.com/XLSView/Index?StudyName=GS-US-417-0301&AppURL=1#tab_1_1";
	...
	public void DART_S01_Web_Verifyscreen()
	{ 
		TM_DART_S01_Web_VerifySparcScreen();
	...
	public void TM_DART_S01_Web_VerifySparcScreen() {

		verifyDARTScreen();

	}

	public void verifyDARTScreen() {
		// Main heading
		wait(5);
		waitForPageLoaded();
