...
public class Pricebox extends CommonMethods {
	/***************************** Test Data *******************/
	final String Browser = "Chrome";
	final String PrdURL = "http://pricebox.gilead.com";
	...
	By img_logo 			=	By.cssSelector("#logo");
	...
	public void TM_S01_Web_Validate_Login_Page() {
		...
		Assert.assertEquals(driver.getTitle(), "Gilead PriceBOX / Login");
	}
}
