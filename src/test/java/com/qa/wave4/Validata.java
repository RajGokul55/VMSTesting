...
public class Validata extends CommonMethods {
	...
	By lnk_ValFileName = By.cssSelector("table[id='tbltflTag'] tr:nth-child(1) td#celltflTag04 div:nth-child(1) span:nth-child(1)");
	...
	By tab_AberrantQties = By.cssSelector("ul[id='dataManagement'] li:nth-child(1) a");
